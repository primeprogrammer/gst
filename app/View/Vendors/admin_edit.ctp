 ...
 <div class="content-wrapper">
        ...
        <div class="page-title">
          ...
          <div>
            ...
            <h1><i class="fa fa-edit"></i>Vendor Edit</h1>
        ...
        <div class="row">
          ...
          <div class="col-md-8 col-md-offset-2">
           ...
           <center> <div class="card" style="height:480px">
		    ...
		    <h3 class="card-title" style="font-family:raleway">EDIT VENDOR</h3>
      ...
      <?php echo $this->Form->create('Vendor',array('class'=>'form-horizontal')); ?>            
         ...
         <div class="form-group">
					...
					<div class="col-sm-9">
                     ...
                     <?php echo $this->Form->input('name',array('class'=>'form-control','label'=>false,'div'=>false,'placeholder'=>'Enter Agent name'));

                         echo $this->Form->hidden('id',array('class'=>'form-control','label'=>false,'div'=>false,'placeholder'=>'Enter Agent name')); 
 ...
 ?>
  ...
  <div class="form-group">
	...
	<label class="control-label  col-sm-3">Address</label>
	 ...
	 <?php echo $this->Form->textarea('address',array('class'=>'form-control','label'=>false,'div'=>false,'placeholder'=>'Enter contact number')); ?>
