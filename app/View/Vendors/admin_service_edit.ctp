 ...
 <div class="content-wrapper">
        ...
        <div class="page-title">
          ...
          <div>
            ...
            <h1><i class="fa fa-edit"></i>Update Product/Service</h1>
          ...
          <div>
            ...
            <ul class="breadcrumb">
              ...
              <li><a href="">Update Product/Service</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-8 col-md-offset-2">
           ...
           <center> <div class="card" style="height:480px">
		    ...
		    <h3 class="card-title" style="font-family:raleway">UPDATE PRODUCT/SERVICE</h3>
