        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
			      ...
			      <?php 
				   ...
				   foreach($invoices as $invoice){
                     ...
                     foreach( $invoice['Invservice'] as $service){
									 ...
									 if($service['sgst']>0){
							 $sgst+=floatval($service['taxable_amt'])/2;  
						   }
						   
						   if($service['cgst']>0){
							  $cgst+=floatval($service['taxable_amt'])/2;   
							   
						   }
						   
						   if($service['igst']>0){
							$igst+=floatval($service['taxable_amt']);     
			  ...
			  $grand_total= $total_amt-$taxable_amt;
			 ...
			 // echo "total amount"+ $grand_total+"<br>";
                  ...
                  <center><div class="total_div" >
				      <span class="total">Taxable Total -</span>&nbsp;&nbsp;&nbsp;<span class="inner"><i class="fa fa-inr"></i><span id="val1"> <?php echo number_format($grand_total,2);?></span></span>
				  
				  
				  </div>
				  <div class="total_div">
				      &nbsp;&nbsp;&nbsp;<span class="total">Total Tax -</span>&nbsp;&nbsp;&nbsp;<span class="inner"><i class="fa fa-inr"></i><span id="val2">  <?php echo number_format($total_tax,2);?></span></span>
				  
				  
				  </div>
				  
				  <div class="total_div">
				      &nbsp;&nbsp;&nbsp;<span class="total">SGST -</span>&nbsp;&nbsp;&nbsp;<span class="inner"><i class="fa fa-inr"></i><span id="val3">  <?php echo number_format($c_gst,2)?></span></span>
				  
				  
				  </div>
				  
				  <div class="total_div">
				      &nbsp;&nbsp;&nbsp;<span class="total">CGST -</span>&nbsp;&nbsp;&nbsp;<span class="inner"><i class="fa fa-inr"></i><span id="val4">  <?php echo number_format($s_gst,2);?></span></span>
				  
				  
				  </div>
				  
				  <div class="total_div">
				      &nbsp;&nbsp;&nbsp;<span class="total">IGST -</span>&nbsp;&nbsp;&nbsp;<span class="inner"><i class="fa fa-inr"></i><span id="val5">  <?php echo number_format($i_gst,2);?></span></span>
