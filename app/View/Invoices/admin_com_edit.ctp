 ...
 <div class="content-wrapper">
          ...
          <div class="col-md-8 col-md-offset-2">
           <center> <div class="card" style="height:520px">
		    ...
		    <h3 class="card-title" style="font-family:raleway">EDIT COMPANY</h3>
			<hr>
         ...
         <div class="form-group">
					...
					<div class="col-sm-9">
                     <?php echo $this->Form->input('name',array('class'=>'form-control','label'=>false,'div'=>false,'placeholder'=>'Enter company name'));
                          echo $this->Form->hidden('id',array('class'=>'form-control','label'=>false,'div'=>false,'placeholder'=>'Enter company name'));
 ?>
                         </div>
				 </div>
	   <div class="form-group">
